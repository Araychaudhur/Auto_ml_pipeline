...
def prediction_data():
    ...
    if result == 0:
        return render_template("results.html", final_result = "The customer's yearly income is less than or equal to $50k:{}".format(result))
    elif result == 1:
        return render_template("results.html", final_result = "The customer's yearly income is more than $50k:{}".format(result))
